...
assert.deepEqual(mined.edit, { $: "world_state.Edit", x: 2n, y: 1n, z: 2n, block: 0 });
...
assert.deepEqual(placed.edit, { $: "world_state.Edit", x: 3n, y: 1n, z: 4n, block: 1 });
...
assert.deepEqual(blocked.edit, { $: "world_state.Edit", x: 3n, y: 1n, z: 4n, block: 1 });
